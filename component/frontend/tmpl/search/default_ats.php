...
/** @var  \Akeeba\Component\DocImport\Site\Model\Search\Result\AkeebaTicket[]  $items */
/** @var  int $count */
...
<div class="alert alert-info">
	<?php if (empty($count)): ?>
		<?= Text::_('COM_DOCIMPORT_SEARCH_ERR_NO_ATS'); ?>
	<?php else: ?>
		<?= Text::_('COM_DOCIMPORT_SEARCH_ERR_NOMORE_ATS'); ?>
	<?php endif; ?>
</div>
<?php return; endif; ?>
